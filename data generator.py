...
company_names = [
    ...
    "OakTree Holdings", "Nimbus Finance", "BrightPath", "Pioneer Trust", "SummitCorp", "Aurora Investments",
    "HorizonX", "Vertex Capital", "Crescent Partners", "Trinity Wealth", "Evergreen Capital", "Magneto Holdings",
    "CoreVision", "NextGen Finance", "Altitude Assets", "Infinity Capital", "VertexOne", "Strive Financial"
]
...
for i in range(NUM_INVESTORS):
    ...
    for j in range(num_portfolios):
        ...
        for m in range(12):
            ...
            value = base * random.randint(1,2)
            invested_value += value
            sql_statements.append(f"INSERT INTO InvestedValue (Date, PID, Phone, Amount) VALUES ('{date}', {pid}, '{phone}', {invested_value});")
            sql_statements.append(f"INSERT INTO TransactionLog (DateTime, Asset_ID, PID, Type, Fee) VALUES ('{date}', {stock_ids[0]}, {pid}, 'TopUp', 50);")
            sql_statements.append(f"INSERT INTO TransactionLog (DateTime, Asset_ID, PID, Type, Fee) VALUES ('{date}', {stock_ids[1]}, {pid}, 'TopUp', 50);")
            sql_statements.append(f"INSERT INTO TransactionLog (DateTime, Asset_ID, PID, Type, Fee) VALUES ('{date}', {fund_id}, {pid}, 'TopUp', 50);")
            sql_statements.append(f"INSERT INTO TransactionLog (DateTime, Asset_ID, PID, Type, Fee) VALUES ('{date}', {bond_id}, {pid}, 'TopUp', 50);")
        ...
        for n in range(12):
            match n:
                ...
                case 11:
                    date = '2024-12-31'
            ugl = values[n]
            sql_statements.append(f"INSERT INTO UnrealisedGainLoss (Date, PID, Phone, Amount) VALUES ('{date}', {pid}, '{phone}', {ugl});")
